...
void nuklear_console_demo_init(struct nk_context* ctx) {
    ...
    {
        nk_console_add_checkbox(options, "Show Window Title", &showWindowTitle)->description = "Whether or not to show the window title";
        nk_console_add_progress(options, "Progress", &progressValue, 100);
        nk_console_add_combobox(options, "ComboBox", "Fists;Chainsaw;Pistol;Shotgun;Chaingun", ';', &weapon)->description = "Choose a weapon!";
        ...
        nk_console_add_slider_float(options, "Slider Float", 0.0f, &slider_float_test, 2.0f, 0.1f)->description = "Slider float is cool";
        ...
        options->description = "Displays some random options!";
    }
