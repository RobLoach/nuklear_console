...
// Auto-detect nuklear_gamepad if already included before this header.
...
// Stub types so nuklear_console.h compiles without nuklear_gamepad.h.
// To enable gamepad support: include nuklear_gamepad.h BEFORE nuklear_console.h.
struct nk_gamepads;
