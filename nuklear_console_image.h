...
NK_API nk_console *nk_console_image_color(nk_console *parent,
                                          struct nk_image image,
                                          struct nk_color color);
NK_API struct nk_rect nk_console_image_render(nk_console *widget);

NK_API void nk_console_image_set_image(nk_console *widget,
                                       struct nk_image image);
NK_API struct nk_image nk_console_image_get_image(nk_console *widget);

NK_API void nk_console_image_set_color(nk_console *widget,
                                       struct nk_color color);
